...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    static android.hardware.Camera mCamera;
    static android.hardware.Camera.Parameters mParameters;
    ...
    public static void passCamera(android.hardware.Camera camera) {
        mCamera = camera;
    ...
    private static String getDefaultPreviewSize() {
        android.hardware.Camera.Size previewSize = mParameters.getPreviewSize();
        return previewSize.width + "x" + previewSize.height;
    }

    private static String getDefaultPictureSize() {
        android.hardware.Camera.Size pictureSize = mParameters.getPictureSize();
        return pictureSize.width + "x" + pictureSize.height;
    }

    private static String getDefaultVideoSize() {
        android.hardware.Camera.Size VideoSize = mParameters.getPreferredPreviewSizeForVideo();
    ...
    private void cameraSizeListToListPreference(List<android.hardware.Camera.Size> list, String key) {
